...
<body>
      <div class="col-md-12">
        ...
        <div class="form-group">
        	<label  class="col-sm-3 control-label"for="profileImage">프로필 사진 수정</label>
        	 <div class="col-sm-6">
		 ...
		 <div class="form-group">
          <div class="col-sm-12 text-center">
            <button class="btn btn-info" id ="modifyBtn"type="submit">수정하기<i class="fa fa-check spaceLeft" ></i></button>
